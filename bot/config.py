...
START_MESSAGE = """<blockquote expandable><b>⚡ Hᴇʏ {}\n\nI ᴀᴍ ᴛʜᴇ ᴍᴏꜱᴛ ᴘᴏᴡᴇʀꜰᴜʟ ɪɴᴅᴇx ʙᴏᴛ ᴡɪᴛʜ ᴘʀᴇᴍɪᴜᴍ ꜰᴇᴀᴛᴜʀᴇꜱ,Tʜɪꜱ ɪꜱ ᴀ ᴄᴇɴᴛʀᴇ ᴛᴏ ᴡᴀᴛᴄʜ ʏᴏᴜʀ ꜰᴀᴠᴏᴜʀɪᴛᴇ ᴀɴɪᴍᴇ ʟᴇᴛ'ꜱ ʀᴏʟʟ!</b></blockquote><b> \n‣ Mᴀɪɴᴛᴀɪɴᴇᴅ Bʏ :</b><a href="https://t.me/Here_remo">Ꮢᴇᴍᴏ</a>"""
